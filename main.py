...
class ImageNet_DataModule(pl.LightningDataModule):
    def __init__(self,
        ...
        self.train = ImageNet(root=dset_dir, transform=self.transform_train, split='train')

        self.val = ImageNet(root=dset_dir, transform=self.transform_val, split='val')
...
if __name__ == "__main__":
    ...
    try:
        ...
        model.max_epochs = opt.max_epochs
